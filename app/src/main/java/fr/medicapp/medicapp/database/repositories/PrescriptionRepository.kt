...
class PrescriptionRepository(context: Context) : Repository(context = context) {
    ...
    fun insert(prescription: Prescription): Long {
        prescription.prescriptionInformation.doctorId = DoctorRepository(context).insert(prescription.doctor!!)
        prescription.prescriptionInformation.medicationId = prescription.medication!!.medicationInformation.id
