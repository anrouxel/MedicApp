...
class HasSmrOpinionsRepository(
    ...
    /**
     * Récupère toutes les entités HasSmrOpinions de la base de données avec le code CIS pour un médicament spécifique.
     *
     * @param cisCode Le code CIS du médicament pour lequel récupérer les entités HasSmrOpinions.
     * @return Une liste de toutes les entités HasSmrOpinions correspondant au code CIS donné.
     */
    fun getByCisCode(cisCode: String): List<HasSmrOpinionsEntity> {
        return hasSmrOpinionsDao.getByCisCode(cisCode)
    }
