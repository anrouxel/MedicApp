...
fun PrescriptionEditTreatment(
    ...
    Edit(
        ...
        bottomText = "Suivant",
        onClick = onClick,
        enabled = state.value.treatment.medication != null && state.value.treatment.posology.isNotEmpty() && state.value.treatment.posology.isNotBlank() && state.value.treatment.frequency.isNotEmpty() && state.value.treatment.frequency.isNotBlank() && state.value.treatment.duration != null
    ) {
